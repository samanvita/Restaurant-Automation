...
public class Table extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        table1.setOnClickListener(Table.this);
        table2.setOnClickListener(Table.this);
    ...
    public void onClick(View v) {
        int id = v.getId();
        String num;Intent x;BackGround b;
        switch(id) {

            case R.id.table1:
                table1.setBackground(table_red);
                Toast.makeText(this, "Take your seat !", Toast.LENGTH_SHORT).show();
                table1.setEnabled(false);
                num = getTableNum(R.id.table1);
                chosentable=num;
                b = new BackGround();
                b.execute(num, "red");
                x = new Intent(this, Customer.class);
                //x.putExtra("number", num);
                startActivity(x);break;
            case R.id.table2:
                table2.setBackground(table_red);
                Toast.makeText(this, "Take your seat !", Toast.LENGTH_SHORT).show();
               ...
               // x.putExtra("number", num);
                startActivity(x);break;
            case R.id.table3:
                table3.setBackground(table_red);
                Toast.makeText(this, "Take your seat !", Toast.LENGTH_SHORT).show();
                ...
                startActivity(x);break;
            case R.id.table4:
                table4.setBackground(table_red);
                Toast.makeText(this, "Take your seat !", Toast.LENGTH_SHORT).show();
                ...
                startActivity(x);break;
            case R.id.table5:
                table5.setBackground(table_red);
                Toast.makeText(this, "Take your seat !", Toast.LENGTH_SHORT).show();
                ...
                startActivity(x);break;
            case R.id.table6:
                table6.setBackground(table_red);
                Toast.makeText(this, "Take your seat !", Toast.LENGTH_SHORT).show();
                ...
                startActivity(x);break;
            case R.id.table7:
                table7.setBackground(table_red);
                Toast.makeText(this, "Take your seat !", Toast.LENGTH_SHORT).show();
                ...
                startActivity(x);break;
            case R.id.table8:
                table8.setBackground(table_red);
                Toast.makeText(this, "Take your seat !", Toast.LENGTH_SHORT).show();
    ...
    class BackGround extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            //else
            //s="Not saved";
            Toast.makeText(Table.this, s, Toast.LENGTH_LONG).show();
        }
    }
    ...
    public void getJSON(String url) {
        class GetJSON extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(Table.this, "Please Wait...", null, true, true);
            }
